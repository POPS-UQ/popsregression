...
\toprule
 & \multicolumn{4}{c}{2 units/param} & \multicolumn{4}{c}{60 units/param} \\
Method & cov. & IS & NLL$_b$ & A$_{abs}$ & cov. & IS & NLL$_b$ & A$_{abs}$ \\
\midrule
...
\begin{tabular}{lcccccccc}
\toprule
 & \multicolumn{4}{c}{1 units/param} & \multicolumn{4}{c}{10 units/param} \\
Method & cov. & IS & NLL$_b$ & A$_{abs}$ & cov. & IS & NLL$_b$ & A$_{abs}$ \\
\midrule
...
\begin{tabular}{lcccccccc}
\toprule
 & \multicolumn{4}{c}{1.4 units/param} & \multicolumn{4}{c}{19 units/param} \\
Method & cov. & IS & NLL$_b$ & A$_{abs}$ & cov. & IS & NLL$_b$ & A$_{abs}$ \\
\midrule
